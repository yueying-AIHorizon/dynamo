...
func (in *CheckpointConfiguration) DeepCopyInto(out *CheckpointConfiguration) {
	*out = *in
	if in.Seccomp != nil {
		...
		*out = new(CheckpointSeccompConfiguration)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckpointSeccompConfiguration) DeepCopyInto(out *CheckpointSeccompConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointSeccompConfiguration.
func (in *CheckpointSeccompConfiguration) DeepCopy() *CheckpointSeccompConfiguration {
	if in == nil {
		return nil
	}
	out := new(CheckpointSeccompConfiguration)
...
func (in *OrchestratorConfiguration) DeepCopyInto(out *OrchestratorConfiguration) {
	*out = *in
	...
	in.VolcanoScheduler.DeepCopyInto(&out.VolcanoScheduler)
}
