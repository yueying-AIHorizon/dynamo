...
For Dynamo's own runtime metrics (`dynamo_*`), see the [Metrics Guide](../../kubernetes/operations/observability.mdx). For backend-specific setup and details, see:

- [vLLM Observability](../../developer-guide/knowledge-base/modular-components/backends/vllm/observability.md)
- [SGLang Observability](../../developer-guide/knowledge-base/modular-components/backends/sglang/observability.md)
- [TensorRT-LLM Observability](../../developer-guide/knowledge-base/modular-components/backends/tensorrt-llm/observability.md)
...
For Dynamo frontend and router metrics (`dynamo_frontend_*`, `dynamo_component_router_*`), see the [Metrics Guide](../../kubernetes/operations/observability.mdx).
