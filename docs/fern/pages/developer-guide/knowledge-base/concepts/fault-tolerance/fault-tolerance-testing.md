...
subtitle: Pytest infrastructure for cancellation, migration, etcd high availability, and hardware fault injection.
---
...
- [Request Migration](request-migration-architecture.md) - Migration implementation details
- [Request Cancellation](request-cancellation-architecture.md) - Cancellation implementation
- [Health Check Reference](../../../../reference/observability/health-checks.mdx) - Health monitoring
